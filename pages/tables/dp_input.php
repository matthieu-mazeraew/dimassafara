...
$query = "insert INTO tb_datapendaftar VALUES ('$nim',' $nama_pendaftar', '$jurusan', '$prodi', '$semester', '$ipk', '$prestasi_non_aka', '$keikutsertaan_ormawa', '$tanggungan_ortu', '$penghasilan_ortu')";
